...
These are tools, not source code. Jules has merged PRs containing `.orig` and `patch.diff` files (PR #46) — they create noise in git history and should never be committed.
